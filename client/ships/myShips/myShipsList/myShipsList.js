...
Template.myShipsList.created = function(){
    var page = parseInt(Session.get('currentPage'));
    var totalShips = Meteor.call("myShipsCount", function(error,result){ Session.set("myPaginationTotal",result);} );
    Session.set("myPaginationLimit",2);
    Session.set("myPaginationOf","Ship");
}
