...
Ship.prototype.update = function (du) {
	...
	var collider=spatialManager.findEntityInRange(this.cx,this.cy,this.getRadius());
	
	if (collider)
	{
/*		var canTakeHit = collider.takeBulletHit;
		if(canTakeHit) canTakeHit.call(collider);
*/		// the two lines above can be included with the logic that if
		// a bullet can damage it a freaking spaship crashing into it will also	do damage
		this.warp();
	}
	else
		spatialManager.register(this);
